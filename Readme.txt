...
Repositori ini berisi source code web pemesanan nasi kotak sederhana menggunakan PHP, JSON, dan CSS.
...
1. Clone repository ini:
    ...
    \`\`\`
2. Jalankan di server lokal seperti XAMPP (taruh di folder htdocs)
